...
class aula1 extends StatefulWidget {
  const aula1({Key? key}) : super(key: key);

  @override
  _aula1State createState() => _aula1State();
}

class _aula1State extends State<aula1> {
  @override
