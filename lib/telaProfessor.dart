...
import 'package:rollcall/aulaProf.dart';
import 'package:firebase_database/firebase_database.dart';

class telaProfessor extends StatefulWidget {

  final String recebido;
  const telaProfessor(this.recebido,{Key? key}) : super(key: key);
...
class _telaProfessorState extends State<telaProfessor> {
  ...
  Future<void> conexao() async {
    ...
    final snapshot = await ref.child('pMaterias/$consulta/mat1').get();
    final snapshot2 = await ref.child('pMaterias/$consulta/mat2').get();
    final snapshot3 = await ref.child('pMaterias/$consulta/mat3').get();
    final snapshot4 = await ref.child('pMaterias/$consulta/mat4').get();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('RollCall - Professor: $nome'),
        centerTitle: true,
      ),
      body: Container(
        child: ListView(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: ElevatedButton(onPressed: (){
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => AulaProf(envioLogin,envioAula,envioNome))
                      );
                    }, child:
                    Row(
